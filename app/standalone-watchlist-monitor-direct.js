...
function getWalletTransactions(address, chain, limit) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    getWalletTxs = require('./lib/ethereum').getWalletTransactions;
                    return [4 /*yield*/, getWalletTxs(address, chain, limit)];
...
function getSolanaTokenTransfers(address) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    getSolTransfers = require('./lib/solana').getSolanaTokenTransfers;
                    return [4 /*yield*/, getSolTransfers(address)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
function notifyWalletTransaction(params) {
    return __awaiter(this, void 0, void 0, function () {
        var notify, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    notify = require('./lib/telegram-client').notifyWalletTransaction;
                    return [4 /*yield*/, notify(params)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.log('Telegram notification skipped:', error_1);
                    return [3 /*break*/, 3];
...
function monitorWatchlist() {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function () {
        var result, now, expiredUsers, deleted, watchlistItems, _loop_1, _i, watchlistItems_1, item, error_2;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    deleted = _e.sent();
                    console.log("[".concat(new Date().toISOString(), "] Cleaned up ").concat(deleted.count, " watchlist items from ").concat(expiredUsers.length, " expired users"));
                    _e.label = 4;
                ...
                case 5:
                    ...
                    console.log("[".concat(new Date().toISOString(), "] Found ").concat(watchlistItems.length, " watchlist items to check"));
                    result.walletsChecked = watchlistItems.length;
                    _loop_1 = function (item) {
                        var transactions, newTransactions, _f, newTransactions_1, tx, hasTokenTransfer, isSent, isReceived, type, tokenTransfer, transfer, alert_1, error_3, error_4;
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                case 0:
                                    _g.trys.push([0, 14, , 15]);
                                    console.log("[".concat(new Date().toISOString(), "] Checking ").concat(item.address, " on ").concat(item.chain, "..."));
                                    transactions = [];
                                ...
                                case 4:
                                    ...
                                    console.log("[".concat(new Date().toISOString(), "] Found ").concat(newTransactions.length, " new transactions for ").concat(item.address));
                                ...
                                case 7:
                                    ...
                                    console.log("[".concat(new Date().toISOString(), "] Created alert for transaction ").concat(tx.hash));
                                ...
                                case 10:
                                    ...
                                    if (error_3.code === 'P2002') {
                                        console.log("[".concat(new Date().toISOString(), "] Skipping duplicate alert for ").concat(tx.hash));
                                        return [3 /*break*/, 11];
                                    }
                                    throw error_3;
                                case 11:
                                ...
                                case 14:
                                    error_4 = _g.sent();
                                    console.error("[".concat(new Date().toISOString(), "] Error checking watchlist item ").concat(item.id, ":"), error_4.message);
                                    result.errors.push("".concat(item.address, " (").concat(item.chain, "): ").concat(error_4.message));
                                    result.results.push({
                                        address: item.address,
                                        chain: item.chain,
                ...
                case 8:
                    ...
                    return [3 /*break*/, 6];
                case 9:
                    console.log("[".concat(new Date().toISOString(), "] Monitoring complete: ").concat(result.walletsChecked, " wallets checked, ").concat(result.alertsCreated, " alerts created"));
                    return [2 /*return*/, result];
                case 10:
                    error_2 = _e.sent();
                    console.error("[".concat(new Date().toISOString(), "] Fatal error during monitoring:"), error_2.message);
                    result.success = false;
                    result.errors.push("Fatal error: ".concat(error_2.message));
                    return [2 /*return*/, result];
