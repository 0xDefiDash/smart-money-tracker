...
var getWalletTransactions;
var getSolanaTokenTransfers;
var notifyWalletTransaction;
function loadLibraries() {
    return __awaiter(this, void 0, void 0, function () {
        var ethLib, solLib, telegramLib, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./lib/ethereum'); })];
                case 1:
                    ethLib = _a.sent();
                    getWalletTransactions = ethLib.getWalletTransactions;
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./lib/solana'); })];
                case 2:
                    solLib = _a.sent();
                    getSolanaTokenTransfers = solLib.getSolanaTokenTransfers;
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./lib/telegram-client'); })];
                case 3:
                    telegramLib = _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Error loading libraries:', error_1.message);
...
function monitorWatchlist() {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function () {
        var startTime, librariesLoaded, now, expiredUsers, deleted, watchlistItems, alertsCreated, results, _loop_1, _i, watchlistItems_1, item, endTime, duration, error_2;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, loadLibraries()];
                case 2:
                    librariesLoaded = _e.sent();
                    if (!librariesLoaded) {
                ...
                case 3:
                    ...
                    if (!(expiredUsers.length > 0)) return [3 /*break*/, 5];
                ...
                case 4:
                    ...
                    _e.label = 5;
                case 5: return [4 /*yield*/, prisma.watchlistItem.findMany({
                        include: {
                            user: {
                                select: {
                                    id: true,
                ...
                case 6:
                        ...
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                case 0:
                                    ...
                                    transactions = [];
                                    if (!librariesLoaded) return [3 /*break*/, 4];
                                ...
                                case 7:
                                    alert_1 = _g.sent();
                                    alertsCreated++;
                                    if (!(item.user.telegramUsername && librariesLoaded)) return [3 /*break*/, 9];
                                ...
                                case 14:
                                    error_4 = _g.sent();
                                    console.error("  \u274C ".concat(item.address, " (").concat(item.chain, "): ").concat(error_4.message));
                                    results.push({
                                        address: item.address,
                                        chain: item.chain,
                    ...
                    _e.label = 7;
                case 7:
                    if (!(_i < watchlistItems_1.length)) return [3 /*break*/, 10];
