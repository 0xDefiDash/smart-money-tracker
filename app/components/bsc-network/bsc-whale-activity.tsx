...
export function BSCWhaleActivity() {
  ...
  const fetchWhaleActivity = async () => {
    ...
    try {
      const response = await fetch(
        `/api/bsc-network/whale-activity?minValue=${minValue}&blockCount=10`
      );
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Large transactions on Binance Smart Chain
            </p>
          </div>
        </div>
        <Button
      ...
      <div className="space-y-3">
        {loading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            No whale transactions found with value ≥ {minValue} BNB
          </div>
        ) : (
          transactions.map((tx) => (
            <Card
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <a
                        ...
                        className="font-mono text-yellow-400 hover:underline flex items-center gap-1"
                      >
                    ...
                    <div>
                      ...
                      <a
                        href={`https://bscscan.com/address/${tx.to || 'Contract Creation'}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-mono text-yellow-400 hover:underline flex items-center gap-1"
                      >
                  ...
                  <div className="flex items-center justify-between">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs font-mono text-muted-foreground hover:text-yellow-400 flex items-center gap-1"
                    >
