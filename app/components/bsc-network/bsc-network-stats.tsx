...
export function BSCNetworkStats() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const response = await fetch('/api/bsc-network/stats');
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <Card className="p-4 bg-gradient-to-br from-yellow-600/10 to-yellow-700/10 border-yellow-600/20">
        <div className="flex items-center justify-between mb-2">
