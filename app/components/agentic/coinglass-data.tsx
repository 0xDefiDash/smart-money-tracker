    ...
    <Card className="bg-black/90 border-green-500/30">
      ...
      <CardContent>
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="w-full bg-black/50 border border-green-500/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-3 mb-4">
                  {multiSentiment.map((s) => {
                    ...
                    return (
                      <div
                        key={s.symbol}
                        className={`p-3 rounded-lg border ${selectedSymbol === s.symbol ? 'border-green-500/50 bg-green-500/10' : 'border-gray-800 bg-black/50'}`}
            ...
            {isLoading ? (
              ...
              <div className="space-y-3">
                ...
                {longShortRatios.map((ratio, idx) => (
                  <div key={idx} className="p-3 rounded-lg bg-black/50 border border-gray-800">
                    <div className="flex items-center justify-between mb-2">
            ...
            {isLoading ? (
              ...
              <div className="space-y-3">
                ...
                {fundingRates.map((fr, idx) => (
                  <div key={idx} className="p-3 rounded-lg bg-black/50 border border-gray-800 flex items-center justify-between">
