 ...
 * Directly executes the monitoring logic without requiring the Next.js server
 */
...
function notifyWalletTransaction(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            console.log("  \uD83D\uDCF1 Would send Telegram notification to @".concat(params.username));
            return [2 /*return*/];
        });
    });
}
                ...
                case 5:
                    ...
                    _loop_1 = function (item) {
                        ...
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                case 0:
                                    console.log("Checking: ".concat(item.address, " (").concat(item.chain, ") - User: ").concat(item.user.email));
                                    _g.label = 1;
                                case 1:
                                ...
                                case 11:
                                    ...
                                    if (error_2.code === 'P2002') {
                                        console.log("  \u23ED\uFE0F  Skipping duplicate alert for ".concat(tx.hash.substring(0, 10), "..."));
                                        return [3 /*break*/, 12];
                                    }
                                    throw error_2;
                                case 12:
