...
/**
 * Ethereum Network RPC Client using Ankr
 * Handles on-chain data fetching from Ethereum mainnet
 */
...
class EthRPCClient {
  ...
  /**
   * Get balance in ETH (converted from wei)
   */
...
export const ethRPCClient = new EthRPCClient();
