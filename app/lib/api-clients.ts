...
export class CoinAPIClient {
  ...
  private getEnhancedFallbackData(): CryptoData[] {
    // Updated current market data for October 8, 2025
    return [
      {
        id: 'bitcoin',
        symbol: 'BTC',
