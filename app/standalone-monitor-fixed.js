...
function monitorWatchlist() {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function () {
        var startTime, now, expiredUsers, cleanedUp, deleted, watchlistItems, alertsCreated, results, _loop_1, _i, watchlistItems_1, item, endTime, duration, error_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    console.log("\u2713 Cleaned up ".concat(cleanedUp, " watchlist items from ").concat(expiredUsers.length, " expired users\n"));
                    _e.label = 4;
                ...
                case 5:
                    ...
                    _loop_1 = function (item) {
                        ...
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                case 0:
                                    console.log("Checking: ".concat(item.address, " (").concat(item.chain, ")"));
                                ...
                                case 1:
                                    ...
                                    transactions = [];
                                    if (!(item.chain === 'solana')) return [3 /*break*/, 3];
                                    return [4 /*yield*/, getSolanaTokenTransfers(item.address)];
                                case 2:
                                    transactions = _g.sent();
                                    return [3 /*break*/, 5];
                                case 3: return [4 /*yield*/, getWalletTransactions(item.address, item.chain, 10)];
                                case 4:
                                    transactions = _g.sent();
                                    _g.label = 5;
                                case 5:
                                    ...
                                    _g.label = 6;
                                case 6:
                                    if (!(_f < newTransactions_1.length)) return [3 /*break*/, 13];
                                ...
                                case 8:
                                    ...
                                    if (!item.user.telegramUsername) return [3 /*break*/, 10];
                                ...
                                case 11:
                                    ...
                                    if (error_2.code === 'P2002') {
                                        console.log("  \u2298 Skipped duplicate alert for ".concat(tx.hash.substring(0, 10), "..."));
                                        return [3 /*break*/, 12];
                                    }
                                    throw error_2;
                                case 12:
                ...
                case 9:
                    ...
                    console.log("Watchlist items cleaned up: ".concat(cleanedUp));
                    console.log("".concat('='.repeat(60), "\n"));
                    return [2 /*return*/, {
                            success: true,
                ...
                case 10:
                    error_1 = _e.sent();
                    console.error("\n\u274C Monitoring failed: ".concat(error_1.message));
                    return [2 /*return*/, {
                            success: false,
